        ...
        <div className="max-w-6xl mx-auto space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                    ...
                    { label: 'Verification Queue', href: '/admin/verification-queue', icon: ClipboardList },
                    { label: 'Treasury Manager', href: '/admin/treasury', icon: Landmark },
                    { label: 'Referral Audit', href: '/admin/referrals', icon: ShieldAlert },
                ].map((action) => (
                    <Button key={action.href} asChild variant="outline" className="h-24 flex flex-col gap-2 border-primary/20 hover:bg-primary/10">
