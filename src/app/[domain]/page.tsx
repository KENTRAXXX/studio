 ...
 * Features a simple landing page for prospects and a partner dashboard for active members.
 */
function AmbassadorPortal() {
    ...
    const referralLink = userProfile?.referralCode 
        ? `https://tradewysetoday.com/plan-selection?ref=${userProfile.referralCode}`
        : '';

    const handleCopy = () => {
        if (!referralLink) return;
        navigator.clipboard.writeText(referralLink);
        toast({ title: 'Link Copied', description: 'Your personal referral link is ready to use.' });
    };
    ...
    const handleDownloadPoster = async () => {
        ...
        try {
            ...
            link.download = `Trade Wyse-Ambassador-${userProfile?.referralCode || 'Partner'}.jpg`;
            link.href = dataUrl;
            link.click();
            toast({ title: 'Image Created', description: 'Your promotion card is ready for social media.' });
        } catch (err) {
        ...
        <div className="min-h-screen flex flex-col selection:bg-primary/30">
            ...
            <header className="p-6 flex justify-between items-center bg-black/40 backdrop-blur-xl border-b border-primary/10 sticky top-0 z-50">
                <Link href={`https://${rootDomain}`} className="flex items-center gap-2 group">
                    <TradeWyseLogo aria-hidden={true} className="h-6 w-6 text-primary transition-transform group-hover:scale-110" />
                    <span className="font-headline font-bold text-xl text-primary tracking-tighter uppercase transition-opacity group-hover:opacity-80">Trade Wyse</span>
                </Link>
                    ...
                    {user ? (
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Button asChild className="font-headline bg-primary text-black font-bold hover:bg-primary/90">
                                <Link href="/signup?planTier=AMBASSADOR&interval=free">Get Started</Link>
                            </Button>
                        </div>
                    )}
                </div>
                    ...
                    <div className="relative">
                        ...
                        <section className="container max-w-6xl mx-auto px-6 py-24 md:py-32 relative z-10 text-center space-y-16">
                            ...
                            >
                                ...
                                <div className="space-y-6 max-w-3xl mx-auto">
                                    ...
                                    <p className="text-xl md:text-2xl text-slate-400 font-medium leading-relaxed">
                                        Earn a <span className="text-primary font-bold">$5.00</span> commission for every new store you refer. No inventory, no hassle—just simple rewards.
                                    </p>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12">
                                {[
                                    { icon: DollarSign, title: "Simple Commission", desc: "Earn $5.00 for every new store signup. No limits on how much you can earn." },
                                    { icon: Zap, title: "Special Discount", desc: "Your referrals get 20% off their setup. Faster signups, more rewards for you." },
                                    { icon: Activity, title: "Live Stats", desc: "Track your clicks, signups, and earnings through your dashboard." }
                                ].map((item, i) => (
                                    <motion.div 
                                        key={i}
                                        initial={{ opacity: 0, y: 20 }}
                    ...
                    <div className="container max-w-6xl mx-auto py-12 px-6 space-y-10">
                        <AnimatePresence mode="wait">
                                ...
                                >
                                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                                        <div>
                                            ...
                                            <p className="text-slate-500 mt-2 text-sm uppercase tracking-[0.4em] font-black">My Stats</p>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <Card className="border-primary/10 bg-slate-900/40 backdrop-blur-sm group hover:border-primary/30 transition-all">
                                            <CardHeader className="flex flex-row items-center justify-between pb-2">
                                                <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Total Commissions</CardTitle>
                                        ...
                                        <Card className="border-primary/10 bg-slate-900/40 backdrop-blur-sm group hover:border-primary/30 transition-all">
                                            <CardHeader className="flex flex-row items-center justify-between pb-2">
                                                <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Referral Activity</CardTitle>
                                            ...
                                            <CardContent>
                                                <div className="flex justify-between items-end">
                                                    <div>
                                                        ...
                                                        <p className="text-[10px] text-slate-500 uppercase tracking-widest mt-2 font-bold">Successful Signups</p>
                                                    </div>
                                        ...
                                        <Card className="border-primary/10 bg-slate-900/40 backdrop-blur-sm group hover:border-primary/30 transition-all">
                                            ...
                                            <CardContent>
                                                <div className="text-xl font-bold text-primary uppercase tracking-widest">ACTIVE</div>
                                                <p className="text-[10px] text-slate-500 uppercase tracking-widest mt-2 font-bold">Partner Account Verified</p>
                                            </CardContent>
                                        </Card>
                                    </div>
                                        ...
                                        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10">
                                            <div className="space-y-6 text-center lg:text-left flex-1">
                                                ...
                                                <p className="text-slate-400 max-w-lg text-lg leading-relaxed">
                                                    People who use this link get a **20% setup discount**, and you earn your **$5.00 commission**.
                                                </p>
                                            </div>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pb-20">
                                        <div className="space-y-6">
                                            ...
                                            <div className="space-y-4">
                                                {[
                                                    "Commissions are paid after the first successful signup.",
                                                    "There is a 14-day verification period to prevent fake signups.",
                                                    "Referring yourself will result in account closure."
                                                ].map((rule, i) => (
                                        ...
                                        <div className="flex flex-col gap-4 justify-end">
                                            ...
                                            >
                                                Access Trade Wyse Wallet <DollarSign className="ml-2 h-6 w-6" />
                                            </Button>
                                            <Button 
                            ...
                            {activeView === 'wallet' && (
                                ...
                                >
                                    <div className="text-center space-y-2">
                                        <h2 className="text-3xl font-bold font-headline text-primary">Your Wallet</h2>
                                        <p className="text-slate-500 uppercase text-[10px] font-black tracking-[0.3em]">Earnings & Payouts</p>
                                    </div>
                                    ...
                                    <Card className="border-primary bg-primary/5 text-center p-10 relative overflow-hidden shadow-gold-glow">
                                        ...
                                        <CardContent className="p-0 mt-8 space-y-6">
                                            ...
                                            <p className="text-[10px] text-slate-500 italic">Payments are processed via bank transfer within 48 business hours.</p>
                                        </CardContent>
                                    </Card>
                                    ...
                                    <div className="space-y-4">
                                        <h3 className="text-xs font-black uppercase text-slate-500 tracking-widest">Program Security</h3>
                                        <div className="p-4 rounded-xl border border-white/5 bg-slate-900/40 text-xs text-slate-400 leading-relaxed">
                                            All rewards have a 14-day verification period. This helps us confirm that all referrals are real and prevents system abuse.
                                        </div>
                                    </div>
                                </motion.div>
                            )}
                            ...
                            {activeView === 'marketing' && (
                                ...
                                >
                                    <div className="text-center space-y-2">
                                        <h2 className="text-3xl font-bold font-headline text-primary">Helpful Tools</h2>
                                        <p className="text-slate-500 uppercase text-[10px] font-black tracking-[0.3em]">Ways to Promote</p>
                                    </div>
                                        ...
                                        <div className="space-y-6">
                                            <Card className="border-primary/20 bg-slate-900/40 p-8 space-y-6">
                                                ...
                                                <div className="space-y-2">
                                                    <h3 className="text-xl font-bold text-white font-headline">Ready-to-use Posts</h3>
                                                    <p className="text-sm text-slate-500 leading-relaxed">Copy and paste these scripts to help you get started.</p>
                                                </div>
                                                <div className="space-y-4">
                                                    {[
                                                        "Launch your luxury empire in 5 minutes with @Trade WyseExecutive. Get 20% off all setup tiers using my link...",
                                                        "Stop building on rented land. Own your customer data and luxury branding with Trade Wyse. Access my partner discount here...",
                                            ...
                                            <Card className="border-primary/20 bg-slate-900/40 p-8 space-y-6">
                                                ...
                                                <div className="space-y-2">
                                                    <h3 className="text-xl font-bold text-white font-headline">Professional Images</h3>
                                                    <p className="text-sm text-slate-500 leading-relaxed">Official images you can use to show off the platform.</p>
                                                </div>
                                                <div className="grid grid-cols-2 gap-3">
                                                    {[1, 2, 3, 4].map(i => (
                                                        <div key={i} className="aspect-video relative rounded-lg overflow-hidden border border-white/5 group">
                                                            <img src={`https://picsum.photos/seed/Trade Wyse-asset-${i}/400/225`} className="object-cover opacity-60 group-hover:opacity-100 transition-opacity" alt="Platform Visual" />
                                                ...
                                                <div className="relative aspect-[9/16] w-full max-w-[300px] mx-auto rounded-xl border-4 border-black/40 shadow-2xl overflow-hidden bg-slate-900">
                                                    ...
                                                    >
                                                        ...
                                                        <div className="space-y-10 z-10 pt-10">
                                                            <TradeWyseLogo className="h-24 w-24 text-primary mx-auto" />
                                                            <h2 className="text-7xl font-headline font-black text-primary uppercase tracking-[0.2em]">Trade Wyse</h2>
                                                        </div>
                                                        <div className="space-y-12 z-10 w-full px-10">
                                                            ...
                                                            <div className="p-10 rounded-2xl bg-primary/10 border-2 border-primary/30 space-y-4">
                                                                <p className="text-2xl font-bold text-primary uppercase tracking-widest">Partner Discount Code</p>
                                                                <p className="text-9xl font-mono font-black text-white tracking-widest">{userProfile?.referralCode || 'ELITE'}</p>
                                                            </div>
                                                            <p className="text-2xl text-slate-500 uppercase tracking-[0.5em] font-medium pt-10">Verification required at tradewysetoday.com</p>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <footer className="p-12 border-t border-primary/10 bg-black/50 text-center relative z-10">
                <p className="text-[10px] uppercase tracking-[0.6em] text-slate-600 font-black">Trade Wyse</p>
            </footer>
        </div>
    );
}
