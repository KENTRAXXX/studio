...
export default function StorefrontPage() {
  ...
  // Firestore hooks
  const storeRef = !isDemoMode && firestore && storeId ? doc(firestore, 'stores', storeId) : null;
  const { data: storeData, loading: storeLoading } = useDoc(storeRef);
  const productsRef = !isDemoMode && firestore && storeId ? collection(firestore, 'stores', storeId, 'products') : null;
