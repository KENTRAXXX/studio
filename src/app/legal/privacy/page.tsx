    ...
    <div className="min-h-screen bg-black text-neutral-200 font-body selection:bg-primary/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 max-w-5xl">
            <div className="text-center mb-20 space-y-4">
                ...
                <p className="text-neutral-500 uppercase tracking-[0.3em] text-sm">Trade Wyse Strategic Assets Group | Security Directive</p>
                <div className="w-24 h-1 bg-primary mx-auto mt-8" />
            </div>

            <div className="space-y-16">
                <PrivacySection title="1. Data Sovereignty">
                    <p>At Trade Wyse, we recognize that in the luxury e-commerce ecosystem, data is the ultimate asset. We collect only what is essential for technical orchestration: your professional identity, business credentials, and store configuration telemetry.</p>
                    <p>Your customer data is your own. Trade Wyse acts as the custodian, providing the infrastructure to store and synchronize this data across the global Master Catalog without compromising individual privacy.</p>
                </PrivacySection>

                <PrivacySection title="2. Financial Telemetry">
                    <p>Financial transactions are the pulse of our platform. While we facilitate the flow of funds from Mogul boutiques to the Trade Wyse Treasury and ultimately to your Wallet, we never see or store your customers' full credit card details. This critical data is handled exclusively by our PCI-DSS Level 1 compliant partners (Paystack).</p>
                ...
                <PrivacySection title="4. Deployment & Hosting">
                    <p>By deploying a store on the Trade Wyse domain or your own custom domain, you acknowledge that certain metadata (SSL status, domain DNS records, and brand configuration) is processed by our automated provisioning engine to ensure high-availability and security.</p>
                </PrivacySection>
                ...
                <div className="pt-20 border-t border-primary/10 text-center">
                    ...
                    <p className="text-xs text-neutral-600 uppercase tracking-widest mt-2">© 2026 Trade Wyse Strategic Assets Group. All Protocols Reserved.</p>
                </div>
            </div>
        </div>
    </div>
